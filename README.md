...
The speed was limited. A trajectory was generated by spline function and then added to the previous path to make sure it's smooth. Frenet coordinates were used to make sure it always stays between the lines.
